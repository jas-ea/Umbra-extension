(() => {
  const P = (data) => ({ defaultMode: 'auto', surfaceSelectors: [], ...data });
  ...
  const profiles = [
    ...
    P({
      ...
      quickSelectors: ['[data-testid="tweet"]', '[data-testid="cellInnerDiv"] article', 'article[role="article"]', 'article'],
      preferSelectors: ['[data-testid="tweet"]', '[data-testid="cellInnerDiv"] article', 'article[role="article"]', 'article'],
      surfaceSelectors: ['[data-testid="tweet"]', '[data-testid="cellInnerDiv"] article', 'article[role="article"]'],
      rejectSelectors: ['[data-testid="sidebarColumn"]', '[aria-label*="Timeline" i] nav', '[role="complementary"]', '[data-testid="tweetButton"]', '[data-testid="toolBar"]', '[data-testid="DMDrawer"]', '[aria-label*="Post text" i]', '[data-testid="tweetTextarea_0"]'],
      rejectTokens: ['sidebar', 'trend', 'compose', 'reply', 'toolbar', 'recommend', 'suggestion', 'drawer', 'composer'],
